...
'use strict';
  ...
  * @param {NodeList} elements Element node energy
...
//  Toogle search in mobile device
 ...
 */
   fetchData(url.currentWeather(lat, lon), function (currentWeather) {
      ...
      fetchData(url.airPollution(lat, lon), function (airPollution){
         ...
         card.innerHTML = `
         <h2 class="title-2" id="highlights-labels">Todays Highlights</h2>
         ...
         <div class="highlight-list">
           ...
           <div class="card card-sm highlight-card">
             ...
             <div class="wrapper">
               ...
               <p class="title-1">${humidity}<sub>%</su></p>
             </div>
           </div>
